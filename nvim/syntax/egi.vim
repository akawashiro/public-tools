...
syn keyword egisonSyntax lambda function let letrec do if type macro loop
syn match egisonSyntax "match"
syn match egisonSyntax "match\-lambda"
syn match egisonSyntax "match\-all"
syn match egisonSyntax "match\-all\-lambda"
syn match egisonSyntax "matcher"
syn match egisonSyntax "pattern-constructor"
syn match egisonSyntax "algebraic-data-matcher"
syn match egisonSyntax "assert"
syn match egisonSyntax "assert-equal"
